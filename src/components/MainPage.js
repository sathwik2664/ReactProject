...
const Law = () => {
    return  (
        <>
        <div style={{ 
      backgroundImage: `("https://imgs.search.brave.com/ozim9plr2i1CulValkcoCKN05eGtucpqDUz4gLQG3OA/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9pbWcu/ZnJlZXBpay5jb20v/cHJlbWl1bS1waG90/by9zdGF0dWUtanVz/dGljZS1zeW1ib2wt/bGVnYWwtbGF3LWNv/bmNlcHQtaW1hZ2Vf/MTU3MTI1LTE3NDA4/LmpwZz9zaXplPTYy/NiZleHQ9anBn")` 
    }}>
        ...
        <button type="submit"  class="button">Search</button>
            ...
            <select align="left"  class="search4">
    ...
    <section class="container">
            ...
            <div class="row">
                ...
                <Link align="right" to="/chatbot"> 
                    ...
                    <button class="lawsession" ><h3>AI Assistant</h3>
                    <p>Explore AI-powered solutions to simplify your legal processes and make informed decisions.</p></button>
                </Link></div>
